        ...
        <div className="Error-container">
            ...
            <div className="main">
                <div className="main__text-wrapper">
                    <h1 className="main__title">Ooops.!</h1>
                    <div className="container-34" style={{textAlign: "center"}}>
                        <h2 style={{textAlign: "center", fontSize: "3em"}}><p>{error}</p></h2>
                    </div>


                    <Link to="/" style={{color: 'blueviolet', textAlign: "center", fontSize: "4.5em"}}>
